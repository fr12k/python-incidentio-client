...
class CatalogV2ListEntriesResponseBody:
    """
    Example:
        {'catalog_entries': [{'alias': 'incident-io/core', 'attribute_values': {'abc123': {'array_value':
    ...
    Attributes:
        catalog_entries (List['CatalogEntryV2ResponseBody']):  Example: [{'alias': 'incident-io/core',
