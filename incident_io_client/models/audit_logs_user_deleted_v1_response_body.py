...
T = TypeVar("T", bound="AuditLogsUserDeletedV1ResponseBody")


@attr.s(auto_attribs=True)
class AuditLogsUserDeletedV1ResponseBody:
    """
    Example:
        {'action': 'user.deleted', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata': {'user_base_role_slug':
    ...
    Attributes:
        action (str): The type of log entry that this is Example: user.deleted.
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        audit_logs_user_deleted_v1_response_body = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_user_deleted_v1_response_body.additional_properties = d
        return audit_logs_user_deleted_v1_response_body
