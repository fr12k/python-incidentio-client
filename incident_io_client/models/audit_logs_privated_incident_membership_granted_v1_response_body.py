...
T = TypeVar("T", bound="AuditLogsPrivatedIncidentMembershipGrantedV1ResponseBody")


@attr.s(auto_attribs=True)
class AuditLogsPrivatedIncidentMembershipGrantedV1ResponseBody:
    """
    Example:
        {'action': 'privated_incident_membership.granted', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
    ...
    Attributes:
        action (str): The type of log entry that this is Example: privated_incident_membership.granted.
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        audit_logs_privated_incident_membership_granted_v1_response_body = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_privated_incident_membership_granted_v1_response_body.additional_properties = d
        return audit_logs_privated_incident_membership_granted_v1_response_body
