...
class CatalogV2ShowEntryResponseBody:
    """
    Example:
        {'catalog_entry': {'alias': 'incident-io/core', 'attribute_values': {'abc123': {'array_value':
            ...
            '2021-08-17T13:28:57.801578Z'}, 'catalog_type': {'color': 'slate', 'created_at': '2021-08-17T13:28:57.801578Z',
            'description': 'Represents Kubernetes clusters that we run inside of GKE.', 'estimated_count': 7, 'icon':
    ...
    Attributes:
        catalog_entry (CatalogEntryV2ResponseBody):  Example: {'alias': 'incident-io/core', 'attribute_values':
        ...
        catalog_type (CatalogTypeV2ResponseBody):  Example: {'color': 'slate', 'created_at':
